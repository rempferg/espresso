...
#define __PYX_HAVE__espressomd__scafacos
#define __PYX_HAVE_API__espressomd__scafacos
#include <string.h>
#include <string>
#include "ios"
#include "new"
...
#define __Pyx_MODULE_NAME "espressomd.scafacos"
int __pyx_module_is_main_espressomd__scafacos = 0;

/* Implementation of 'espressomd.scafacos' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initscafacos(void); /*proto*/
PyMODINIT_FUNC initscafacos(void)
#else
PyMODINIT_FUNC PyInit_scafacos(void); /*proto*/
PyMODINIT_FUNC PyInit_scafacos(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_scafacos(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("scafacos", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_espressomd__scafacos) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "espressomd.scafacos")) {
      if (unlikely(PyDict_SetItemString(modules, "espressomd.scafacos", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  __pyx_ptype_10espressomd_6actors_Actor = __Pyx_ImportType("espressomd.actors", "Actor", sizeof(struct __pyx_obj_10espressomd_6actors_Actor), 1); if (unlikely(!__pyx_ptype_10espressomd_6actors_Actor)) __PYX_ERR(2, 2, __pyx_L1_error)
  ...
  __pyx_t_1 = __Pyx_ImportModule("espressomd.utils"); if (!__pyx_t_1) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "handle_errors", (void (**)(void))&__pyx_f_10espressomd_5utils_handle_errors, "PyObject *(PyObject *)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init espressomd.scafacos", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init espressomd.scafacos");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
