...
SRCDIR=$1
BASEFILENAME=$2
TEXINPUTS=.:$SRCDIR:/Users/bindgens2/Documents/espresso_dev/espresso/doc:
BIBINPUTS=.:$SRCDIR:
export TEXINPUTS BIBINPUTS
echo "TEXINPUTS=$TEXINPUTS"

ESPRESSO_VERSION=`cd /Users/bindgens2/Documents/espresso_dev/espresso; sh config/genversion.sh -rd`
